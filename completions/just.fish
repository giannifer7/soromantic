...
# complete targets for build, export, try
set -l soromantic_targets glibc void-musl alpine-musl windows fedora artix ubuntu windows-native
complete -c just -n "__fish_seen_subcommand_from build export try" -a "$soromantic_targets"
